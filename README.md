[![.github/workflows/main.yml](https://github.com/maxfreym/kittygram_final/actions/workflows/main.yml/badge.svg)](https://github.com/maxfreym/kittygram_final/actions/workflows/main.yml)
...
```bash 
git clone git@github.com:maxfreym/kittygram_final.git
```
